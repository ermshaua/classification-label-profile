...
from src.utils import create_state_labels, load_has_datasets, extract_cps, load_tssb_datasets
...
if __name__ == '__main__':
    ...
    dataset, w, cps, labels, ts = load_tssb_datasets(names=("Adiac",)).iloc[0, :]  # Ham, MelbournePedestrian, Crop
